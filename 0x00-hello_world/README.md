...
Write a script that generates the assembly code of a C file and save it in an output file.
- The C file name will be saved in the variable `$CFILE`
...
- Your program should produce the exact same output as in the example
...
Write a script that generates the assembly code (Intel syntax) of a C file and save it in an output file.
- The C file name will be saved in the variable `$CFILE`
- The output file should be named the same as the C file, but with the extension `.s` instead of `.c`
